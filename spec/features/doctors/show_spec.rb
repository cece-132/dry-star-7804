...
RSpec.describe Doctor do
  describe 'Doctor show page' do
    ...
    it 'next to the patient name I see a remove button' do
      ...
      within ".patients" do
        within "#pt-#{@dr_1.patients[0].id}" do
          expect(page).to have_button("Remove Patient")
          click_button "Remove Patient"
          expect(current_path).to eq doctor_path(@dr_1)
        end
      end
      expect(page).to_not have_content("#{@dr_1.patients[0].name}")
